...
Je n'ai pas abandonné mon pragmatisme pour autant, et suis très conscient des technologies encore à l'oeuvre aujourd'hui en industrie. Ma philosophie est donc **mésomorphique**, hybride, à l'image de nos écrans modernes (i.e. _cristaux liquides_) : langage primaire et code **solides**, précis, structurés, concis et vérifiables (par la machine) ; mais runtime, code et langages secondaires **liquides**, flexibles, libres, et adaptables, prenant en compte les contingences du moment dans une entreprise. Du côté de l'équipe technique : un environnement abordable, structuré, familier, et fidèle à la pensée (autour du métier). Du côté de l'exécution de code (clients, contraintes...) : un environnement sur-mesure, adapté à l'enjeu, aux contingences du moment et de l'endroit (e.g. résilience, vitesse, etc.).
