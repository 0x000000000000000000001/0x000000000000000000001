...
Je suis ingénieur/architecte logiciel/web, focalisé sur l'utilisation de la **programmation fonctionnelle pure** (FP), pour déjouer les **contraintes du monde réel**,  **exprimer un métier** avec un **haut degré de précision**, et concevoir des systèmes qui structurent suffisamment l'**espace de recherche** pour que les humains comme les IA convergent naturellement vers les bonnes solutions. 
