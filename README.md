...
*   ⚡ **Lock-free architectures**: I'm exploring interesting [event sourcing patterns]([https://github.com/0x000000000000000000001/ccc-postgres-concurrency-proof](https://github.com/ricofritzsche/ccc-postgres-concurrency-proof/issues/1). I focus on pushing monolithic databases (like PostgreSQL) to FAANG-level scale (60k+ TPS) using custom paradigms like Aggregateless DDD, *Context Collision Observers* (CCO) and optimistic batching.
